...
public class CrudAppTestingSuite {
    private static final String BASE_URL = "https://mzebik.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("zebik.mateusz@gmail.com");
        driverTrello.findElement(By.id("login")).click();

        Thread.sleep(4000);

        driverTrello.findElement(By.id("password")).sendKeys("NoweHaslo01.");
